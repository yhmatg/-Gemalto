...
public class OrderBean {
    ...
    public static class DataBean {
        ...
        public static class OrderInfoBean {
            @SerializedName("ESIMLabel_aCode")
            private String acode;
            @SerializedName("ESIMLabel_barcode")
            private String barCode;
            @SerializedName("ESIMLabel_batch")
            private String batch;
            @SerializedName("ESIMLabel_customerName")
            private String customerName;
            @SerializedName("ESIMLabel_inlay")
            private String inlay;
            @SerializedName("ESIMLabel_location")
            private String location;
            @SerializedName("ESIMLabel_mmyy")
            private int mmyy;
            @SerializedName("ESIMLabel_orderNumber")
            private String orderNumber;
            @SerializedName("ESIMLabel_productName")
            private String productName;
            @SerializedName("ESIMLabel_qty")
            private int esimQty;
            @SerializedName("ESIMLabel_referenceNo")
            private String referenceNo;
            @SerializedName("ESIMLabel_supplierName")
            ...
            public int getEsimQty() {
                return esimQty;
            }

            public void setEsimQty(int esimQty) {
                this.esimQty = esimQty;
            }
